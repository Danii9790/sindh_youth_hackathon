...
/**
 * Database Setup Script for MediAI Pro
 * This script creates the appointments table in your Neon PostgreSQL database
 */
...
async function setupDatabase() {
  ...
  try {
    ...
    const sqlPath = path.join(__dirname, 'create_appointments_table.sql');
